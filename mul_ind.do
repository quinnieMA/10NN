...
bysort neighbor_tar_primary_sic_code year: egen median_pre_ebitda_mul_ly = median(pre_ebitda_mul_ly)
...
* 保留所需变量
keep deal_num year pre_ebitda_mul_ly median_pre_ebitda_mul_ly median_pre_ebitda_mul_ly_1 source_tar_primary_sic_code
